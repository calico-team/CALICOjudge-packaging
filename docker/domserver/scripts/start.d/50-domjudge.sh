...
# Fix Cloud Run weird slow request
echo "fastcgi_buffering off;" >> ${NGINX_CONFIG_FILE}
echo "proxy_buffering off;" >> ${NGINX_CONFIG_FILE}
# Enable file system cache
echo "open_file_cache          max=1000 inactive=20s;" >> ${NGINX_CONFIG_FILE}
